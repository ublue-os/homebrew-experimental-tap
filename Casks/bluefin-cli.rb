...
cask 'bluefin-cli' do
  ...
  preflight do
    ...
    if bling_sh.exist?
      ...
      FileUtils.chmod 0o755, "#{staged_path}/bling/bling.sh"
    end

    if bling_fish.exist?
      File.write("#{staged_path}/bling/bling.fish", bling_fish.read)
      FileUtils.chmod 0o755, "#{staged_path}/bling/bling.fish"
    end
    ...
    FileUtils.chmod 0o755, "#{staged_path}/motd/bluefin-motd"
    ...
    FileUtils.chmod 0o755, "#{staged_path}/bluefin-cli"
  end
